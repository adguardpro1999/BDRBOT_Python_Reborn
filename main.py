...
async def on_message(message):
    ...
    if message.content == "!Version" or message.content.startswith("?version"):
        if message.author.dm_channel:
            ...
            await message.author.dm_channel.send("제 버전은 0.24.1으로 가장 최신버전이에요.")
            await message.author.dm_channel.send("배돌이봇이 다시 reborn 했습니다.") 
            await message.author.dm_channel.send("2018년도에 탄생한 봇으로")  
    ...
    if message.content.startswith("!코로나") or message.content.startswith("!Corona"): 
        msg = await message.channel.send("코로나 종식 선언!")
    ...
    if "섹스" in message.content:
        await message.delete()
        await message.channel.send(f"{message.author.mention} 야! 야한 말은 절대 금물!!")
    ...
    if "씨발" in message.content:
        await message.delete()
        await message.channel.send(f"{message.author.mention} 야~ 그 어는 여성들이 불편해하는 단어야.")
       
    if "씨1발" in message.content:
        await message.delete()
        await message.channel.send(f"{message.author.mention} 야~ 그 단어는 여성들이 불편해하는 단어야.")       
    ...
    if "병신" in message.content:
        await message.delete()
        await message.channel.send(f"{message.author.mention} 야.. 사회적약자들을 모욕하는 단어는 사용하지마렴.")
    ...
    if "애미" in message.content:
        await message.delete()
        await message.channel.send(f"{message.author.mention} 야.. 부,모는 건들지 말자. 니가 사람이니?")
    ...
    if "새끼" in message.content:
        await message.delete()
        await message.channel.send(f"{message.author.mention} 야! 어디서 그런 말을 배웠어!?")
    ...
    if "난교" in message.content:
        await message.delete()
        await message.channel.send(f"{message.author.mention} 야! 야한 말은 절대 안돼!!")
    ...
    if "fuck" in message.content:
        await message.delete()
        await message.channel.send(f"{message.author.mention} 야.. 방금 단어는 여성분들이 불편해하시는 단어야.")
    ...
    if "진핑" in message.content:
        await message.delete()
        await message.channel.send(f"{message.author.mention} 韩国人没有资格骂他。 你的父母死了吗？")
    ...
    if "보지" in message.content:
        await message.delete()
        await message.channel.send(f"{message.author.mention} 야! 야한 말 절대 안돼!!")
    ...
    if "ㅅㅂ" in message.content:
        await message.delete()
        await message.channel.send(f"{message.author.mention} 야~ 그 단어는 여성들이 불편해하는 어야.")
    ...
    if "한남" in message.content:
        await message.delete()
        await message.channel.send(f"{message.author.mention} 야~ 그 단어는 젠,더,갈,등 관련된 단어야.")
    ...
    if "미친" in message.content:
        await message.delete()
        await message.channel.send(f"{message.author.mention} 바르고 고운말을 쓰자구!! ㅎㅎ;")
    ...
    if "봊" in message.content:
        await message.delete()
        await message.channel.send(f"{message.author.mention} 야~ 방금 그 단어는 여성들이 불편해하는 단어야.")
       
    if "좆" in message.content:
        await message.delete()
        await message.channel.send(f"{message.author.mention} 헉! 야한 말은 절대 안돼!!")
       
    if "존나" in message.content:
        await message.delete()
        await message.channel.send(f"{message.author.mention} 헉! 야한 말에서 유래된 비속어 사용은 절대 금물!") 
    ...
    if "닥치" in message.content:
        await message.delete()
        await message.channel.send(f"{message.author.mention} 바르고 고운말을 쓰자구!!")
    ...
    if "ㅄ" in message.content:
        await message.delete()
        await message.channel.send(f"{message.author.mention} 야.. 사회적 약자를 모욕하는 표현은 우리 좀 자제하자?^^7")    
    ...
    if "Fuck" in message.content:
        await message.delete()
        await message.channel.send(f"{message.author.mention} 야~ 방금 그 단어는 여성분들이 불편해하시는 단어야..")  
       
    if "아가리" in message.content:
        await message.delete()
        await message.channel.send(f"{message.author.mention} 야.. 사람 입가지고 그렇게 표현하면 안돼..") 
    ...
    if "보빨" in message.content:
        await message.delete()
        await message.channel.send(f"{message.author.mention} 헐.. 너 혹시 일,베해?") 
    ...
    if "장애" in message.content:
        await message.delete()
        await message.channel.send(f"{message.author.mention} 우리 모두는 전부 결함을 가지고 태어났어.")  
    ...
    if "정공" in message.content:
        await message.delete()
        await message.channel.send(f"{message.author.mention} 사회복무요원들을 욕하지 마렴.")     
    ...
    if "치매" in message.content:
        await message.delete()
        await message.channel.send(f"{message.author.mention} 해당 질병은 누구나 걸릴 수 있단다.. 그런 표현 자제해라.")    
    ...
    if "자살" in message.content:
        await message.channel.send(f"{message.author.mention} 생명은 소중하단다.")
   ...
   # 2021년 04월 24일 오전 3시 33분 여기까지 수정 완료.
   # At 03:33am on 24 Apr 2021. 
   # 2021년 10월 24일 오후 11시 18분 여기까지 수정 완료.
   # At 11:18pm on 24 Oct 2021. 
           


     #2019년 발발한 COVID19 대응 파트 입니다. 2021년 04월 24일 현재도 국내 발생 760명 입니다. 
     #This is the COVID19 response part that broke out in 2019. As of April 24, 2021, the number of confirmed cases in South Korea was 760.
    if message.content.startswith("사람") or message.content.startswith("인간") or message.content.startswith("사회적거리두기") or message.content.startswith("사회적 거리두기") or message.content.startswith("코로나"):
        msg = await message.channel.send("#Stay at Home #사회적 거리두기")
        await asyncio.sleep(4.0)
        await msg.edit(content="코,로,나가 드디어 종식되었어..라고 말하는 날이 올까요?")
        msg2 = await message.channel.send("코,로,나가 끝날때까지 사회적 거리두기에 참여합시다.")
        await asyncio.sleep(5.0)
        await msg2.edit(content="아 오지요. 당연히 오지요. 그날은 올수밖에 없죠.")
        msg3 = await message.channel.send("힘들어도 참는자에게 복이 올거에요.")
        await asyncio.sleep(6.0)
        await msg3.edit(content="그렇죠, 그날은 올수밖에 없죠. 그런데 말이에요. 그때가되면은 우린 없을것 같아요.")
        await msg3.message.delete()        
    ...
    # 대한민국 국민들은 자살 암시 문구들을 남기는 사람들은 죽을 배짱이 없다고 일반화 합니다. 
    # The Korean people generalize that people who leave suicide hints word do not have the guts to die.   
   
       

         
    if message.content.startswith("ㅋㅋㅋ") or message.content.startswith("?help") or message.content.startswith("?MBTI") or message.content.startswith("?Blood type"):  
